...
# Dividir los datos en conjuntos de entrenamiento y prueba (no necesario para validación cruzada)
X = df[["tiempo_tm", "tiempo_vehiculo"]]
y = df["medio_rapido"]
...
print(f"Precisión de validación cruzada: {np.mean(scores)}")